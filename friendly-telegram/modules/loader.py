...
class LoaderMod(loader.Module):
    ...
    strings = {"name": "Загрузчик",
               ...
               "avail_header": "<b>Доступные официальные модули</b>",
               ...
               "scam_module": "<b>Осторожно, в модуле найден SCAM-код для удаления аккаунта! Пожалуйста, отправьте репорт на автора или тому, кто Вам предоставил этот модуль! Чат: @ftgchat</b>"}

    def __init__(self):
        super().__init__()
        self.config = loader.ModuleConfig("MODULES_REPO",
                                          "https://github.com/Jaxer159/modules-repo/raw/master",
